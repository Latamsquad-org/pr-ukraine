...
# - PRDEBUG_ALL
#
# $Id: realityconfig_local.py 42476 2025-03-29 23:12:46Z prbot $
#
#
...
C['KIT_LIMIT_24'] = { 'sniper':     1, 'aa': 1, 'at': 1, 'engineer': 1, 'marksman': 3, 'assault': 4, 'riflemanat': 1,
...
C['KIT_LIMITS_SQUAD'] = {
    ...
    'marksman': 1, 'riflemanat': 1, 'assault': 1, 'support': 1, 'medic': 1, 'riflemanap': 1, 'specialist': 1, 'mg': 1
}
#
#
#
...
C['KIT_ALLOCATION_DELAY'] = {
    'sniper':     600, 'aa': 600, 'at': 600, 'engineer': 600, 'mg': 100, 'spotter': 600, 'marksman': 300, 'riflemanap': 300,
...
C['KIT_PICKUP_DELAY'] = {
    'sniper':     300, 'aa': 100, 'at': 100, 'engineer': 100, 'mg': 300, 'spotter': 300,
...
C['KIT_SUPPLY_OBJECTS'] = {
    ...
    'ru90':          { 'pr_supply_crate_ru':    CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_ru': CONSTANTS.DISTANCE_PICKUP,
                     'fixed_supply_crate_ru': CONSTANTS.DISTANCE_PICKUP },
    ...
    'chinsurgent90': { 'ammocache':              CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP,
                       'light_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP,
                       'fixed_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP },
    'chechen90':    { 'ammocache':              CONSTANTS.DISTANCE_PICKUP, 'pr_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP,
                       'light_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP,
                       'fixed_supply_crate_mil': CONSTANTS.DISTANCE_PICKUP },
...
C['KIT_SUPPLY_OBJECTS_VEHICLES'] = {
    ...
    'ru90':          { 'ru_apc_btr60':     CONSTANTS.DISTANCE_PICKUP, 'ru_apc_btr80': CONSTANTS.DISTANCE_PICKUP,
                     'ru_apc_btr80_alt': CONSTANTS.DISTANCE_PICKUP, 'ru_apc_btr80a': CONSTANTS.DISTANCE_PICKUP,
                     'ru_apc_btr82am': CONSTANTS.DISTANCE_PICKUP,   'ru_ifv_bmp3m': CONSTANTS.DISTANCE_PICKUP,
                     'ru_ifv_bmp3':      CONSTANTS.DISTANCE_PICKUP, 'ru_apc_mtlb': CONSTANTS.DISTANCE_PICKUP,
                     'ru_apc_mtlb_hmg':  CONSTANTS.DISTANCE_PICKUP, 'ru_ifv_bmp2': CONSTANTS.DISTANCE_PICKUP,
...
C['RALLY_TEAMS'] = ['arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'fsa', 'gb', 'gb82', 'ger', 'hamas', 'idf', 'mec',
                    'nl', 'pl', 'ru', 'ru90', 'taliban', 'us', 'usa', 'vnnva', 'vnusa', 'vnusmc', 'ww2ger', 'ww2usa', 'ww2ger41', 'ww2rus', 'ww2rusearly']
#
#
# Teams that use the commander rally point system
# Default is arf, ch, gb, mec, us, usa, cf, chinsurgent, chinsurgent90, ru, ru90, arf, taliban, idf, hamas, ger, vnusa, vnusmc, vnnva, gb82, arg82, fr, nl, ww2ger, ww2usa
C['RALLY_TEAMS_COMMANDER'] = ['arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'fsa', 'gb', 'gb82', 'ger', 'hamas',
                              'idf', 'mec', 'nl', 'pl', 'ru', 'ru90', 'taliban', 'us', 'usa', 'vnnva', 'vnusa',
                              'vnusmc', 'ww2ger', 'ww2usa', 'ww2ger41', 'ww2rus', 'ww2rusearly']
...
C['ASSET_TEAMS'] = ['ch', 'gb', 'mec', 'us', 'usa', 'fsa', 'cf', 'chinsurgent', 'chinsurgent90', 'chechen90', 'meinsurgent', 'pl', 'ru', 'ru90', 'arf', 'taliban',
                    'idf', 'hamas', 'ger', 'vnusa', 'vnusmc', 'vnnva', 'gb82', 'arg82', 'fr', 'nl', 'ww2ger', 'ww2usa', 'ww2ger41', 'ww2rus', 'ww2rusearly']
#
#
