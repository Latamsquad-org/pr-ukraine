...
#
# $Id: realityconfig_coop.py 42476 2025-03-29 23:12:46Z prbot $
#
#
...
C['INSURGENCY_CIV_CARS'] = [
    'civ_bik_dirtbike', 'civ_bik_atv', 'civ_bik_hondacb500', 'civ_jep_forklift',
...
C['KIT_LIMIT_8'] = {
    'sniper': 6, 'aa': 6, 'at': 6, 'engineer': 6, 'marksman': 6, 'assault': 6, 'riflemanat': 6,
    'riflemanap': 6, 'mg': 6, 'spotter': 6
}
C['KIT_LIMIT_16'] = {
    'sniper': 6, 'aa': 6, 'at': 6, 'engineer': 6, 'marksman': 6, 'assault': 6, 'riflemanat': 6,
    'riflemanap': 6, 'mg': 6, 'spotter': 6
...
C['KIT_LIMIT_24'] = {
    'sniper': 8, 'aa': 8, 'at': 8, 'engineer': 8, 'marksman': 8, 'assault': 8, 'riflemanat': 84,
    'riflemanap': 8, 'mg': 8, 'spotter': 8
}
C['KIT_LIMIT_32'] = {
    'sniper': 10, 'aa': 10, 'at': 10, 'engineer': 10, 'marksman': 10, 'assault': 10, 'riflemanat': 10,
    'riflemanap': 10, 'mg': 10, 'spotter': 10
}
C['KIT_LIMIT_44'] = {
    'sniper': 10, 'aa': 10, 'at': 10, 'engineer': 10, 'marksman': 10, 'assault': 10, 'riflemanat': 10,
    'riflemanap': 10, 'mg': 10, 'spotter': 10
...
C['KIT_LIMITS'] = {
    'ch': {
        'marksman': 1, 'support': 1, 'riflemanat': 1, 'assault': 1, 'riflemanap': 1, 'specialist': 1, 'mg': 1,
        'spotter': 1,
    ...
    'meinsurgent': {
        'officer': 1, 'insurgent1': 0, 'insurgent2': 0, 'insurgent3': 0, 'insurgent4': 0, 'sapper': 0,
        'medic': 1, 'tanker': 1
    },
    'vnusa': {
        'support': 1, 'riflemanat': 1, 'assault': 1, 'riflemanap': 1, 'specialist': 1, 'mg': 1, 'spotter': 3,
        'officer': 1, 'sniper': 1, 'at': 1, 'engineer': 1, 'medic': 1, 'tanker': 1, 'pilot': 1, 'rifleman': 0
    },
    'vnusmc': {
        'support': 1, 'riflemanat': 1, 'assault': 1, 'riflemanap': 1, 'specialist': 1, 'mg': 1, 'spotter': 3,
        'officer': 1, 'sniper': 1, 'at': 1, 'engineer': 1, 'medic': 1, 'tanker': 1, 'pilot': 1, 'rifleman': 0
...
# Default is 1
C['KIT_LIMITS_SQUAD'] = {
    'sniper': 2, 'aa': 2, 'at': 2, 'engineer': 2, 'spotter': 2,
    'marksman': 2, 'riflemanat': 2, 'assault': 2, 'support': 2, 'medic': 2, 'riflemanap': 2, 'specialist': 2, 'mg': 2
}
#
#
#
...
C['KIT_ALLOCATION_DELAY'] = {
    'sniper': 60, 'aa': 60, 'at': 60, 'engineer': 60, 'mg': 60, 'spotter': 60, 'marksman': 30, 'riflemanap': 30,
    'riflemanat': 30, 'assault': 30, 'support': 30, 'specialist': 30
}
#
#
...
C['KIT_PICKUP_DELAY'] = {
    'sniper': 30, 'aa': 30, 'at': 30, 'engineer': 30, 'mg': 30, 'spotter': 30,
...
C['RALLY_TEAMS'] = [
    'arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'fsa', 'gb', 'gb82', 'ger', 'hamas', 'idf',
    'mec', 'nl', 'pl', 'ru', 'ru90', 'taliban', 'us', 'usa', 'vnnva', 'vnusa', 'vnusmc', 'ww2ger', 'ww2usa', 'ww2ger41',
    'ww2rus', 'ww2rusearly'
]
#
#
...
C['OUTPOST_TEMPLATES'] = {
    ...
    'pl': ['deployable_firebase_sp'],
    'ru': ['deployable_firebase_sp'],
    'ru90': ['deployable_firebase_sp'],
    'idf': ['deployable_firebase_sp'],
    'arf': ['deployable_insurgent_hideout_sp'],
    'chinsurgent': ['deployable_firebase_sp'],
    'chinsurgent90': ['deployable_firebase_sp'],
    'chechen90': ['deployable_firebase_sp'],
    ...
    'nl': ['deployable_firebase_sp'],
    'ww2ger': ['deployable_firebase_sp'],
    'ww2ger41': ['deployable_firebase_sp'],
    'ww2usa': ['deployable_firebase_sp'],
    'ww2rus': ['deployable_firebase_sp'],
    'ww2rusearly': ['deployable_firebase_sp'],
}
# Hideout ammo regen
...
C['ANTIAIR_TEMPLATES'] = {
    ...
    'pl': ['deployable_djigit_sp'],
    'ru': ['deployable_djigit_sp'],
    'ru90': ['deployable_djigit_sp'],
    'idf': ['deployable_stinger_sp'],
    'arf': ['deployable_dshk_sp'],
    'chinsurgent': ['deployable_dshk_sp'],
    'chinsurgent90': ['deployable_dshk_sp'],
    'chechen90': ['deployable_dshk_sp'],
    'hamas': ['deployable_dshk_sp'],
    'taliban': ['deployable_dshk_sp'],
    'meinsurgent': ['deployable_dshk_sp'],
    'fsa': ['deployable_dshk_sp'],
    'vnnva': ['deployable_dshk_sp'],
    'gb82': ['deployable_stinger_sp'],
    'arg82': ['deployable_djigit_sp'],
    'fr': ['deployable_mistral_sp'],
    'nl': ['deployable_stinger_sp'],
}
#
#
...
C['HMG_TEMPLATES'] = {
    'us': ['deployable_50cal_tripod_m2_sp'],
    'usa': ['deployable_50cal_tripod_m2_sp'],
    'cf': ['deployable_50cal_tripod_m2_sp'],
    'gb': ['deployable_50cal_tripod_m2_sp'],
    'ger': ['deployable_50cal_tripod_m2_sp'],
    'ch': ['deployable_50cal_tripod_type85_sp'],
    'mec': ['deployable_50cal_tripod_kord_sp'],
    'pl': ['deployable_50cal_tripod_kord_sp'],
    'ru': ['deployable_50cal_tripod_kord_sp'],
    'ru90': ['deployable_50cal_tripod_kord_sp'],
    'idf': ['deployable_50cal_tripod_m2_sp'],
    'fsa': ['deployable_50cal_tripod_dshk_sp'],
    'chinsurgent': ['deployable_50cal_tripod_dshk_sp'],
    'chinsurgent90': ['deployable_50cal_tripod_dshk_sp'],
    'chechen90': ['deployable_50cal_tripod_dshk_sp'],
    'vnusa': ['deployable_50cal_tripod_m2_sp'],
    'vnusmc': ['deployable_50cal_tripod_m2_sp'],
    'vnnva': ['deployable_50cal_tripod_dshk_sp'],
    'gb82': ['deployable_50cal_tripod_m2_sp'],
    'arg82': ['deployable_50cal_tripod_m2_sp'],
    'fr': ['deployable_50cal_tripod_m2_sp'],
    'nl': ['deployable_50cal_tripod_m2_sp'],
    'ww2ger': ['deployable_mg42_sp'],
    'ww2ger41': ['deployable_mg42_sp'],
    'ww2usa': ['deployable_m1919a6_sp'],
    'ww2rus': ['deployable_m1910_sp'],
    'ww2rusearly': ['deployable_m1910_sp'],
}
#
#
...
C['TOW_TEMPLATES'] = {
    ...
    'ger': ['deployable_milan_mira_sp'],
    'ch': ['deployable_hj8_sp'],
    'mec': ['deployable_milan_sp'],
    'pl': ['deployable_spike_sp'],
    'ru': ['deployable_kornet_sp'],
    'ru90': ['deployable_spg9_sp'],
    'idf': ['deployable_tow_sp'],
    'arf': ['deployable_spg9_sp'],
    'chinsurgent': ['deployable_spg9_sp'],
    'chinsurgent90': ['deployable_spg9_sp'],
    'chechen90': ['deployable_spg9_sp'],
    'fsa': ['deployable_hj8_sp', 'deployable_milan_sp', 'deployable_tow_sp', 'deployable_kornet_sp'],
    'taliban': ['deployable_spg9_sp'],
    'hamas': ['deployable_spg9_sp'],
    'meinsurgent': ['deployable_spg9_sp'],
    'vnnva': ['deployable_spg9_sp'],
    'gb82': ['deployable_milan_sp'],
    'arg82': ['deployable_spg9_sp'],
    'fr': ['deployable_milan_mira_sp'],
    'nl': ['deployable_spike_sp'],
}
#
#
...
C['MORTAR_TEMPLATES'] = {
    ...
    'ch': ['deployable_mortar_pp87_sp'],
    'mec': ['deployable_mortar_m252_sp'],
    'pl': ['deployable_mortar_m252_sp'],
    'ru': ['deployable_mortar_2b141_podnos_sp'],
    'ru90': ['deployable_mortar_2b141_podnos_sp'],
    'idf': ['deployable_mortar_m252_sp'],
    'arf': [],
    'chinsurgent': ['deployable_mortar_2b141_podnos_sp'],
    'chinsurgent90': ['deployable_mortar_2b141_podnos_sp'],
    'chechen90': ['deployable_mortar_2b141_podnos_sp'],
    'taliban': ['deployable_mortar_m252_ins_sp'],
    'hamas': ['deployable_mortar_m252_ins_sp'],
    'meinsurgent': ['deployable_mortar_m252_ins_sp'],
    'fsa': ['deployable_mortar_m252_ins_sp'],
    'vnusa': ['deployable_mortar_m252_sp'],
    'vnusmc': ['deployable_mortar_m252_sp'],
    'vnnva': ['deployable_mortar_m252_sp'],
    'gb82': ['deployable_mortar_m252_sp'],
    'arg82': ['deployable_mortar_m252_sp'],
    'fr': ['deployable_mortar_m252_sp'],
    'nl': ['deployable_mortar_m252_sp'],
    'ww2ger': [],
    'ww2ger41': [],
    'ww2usa': [],
    'ww2rus': [],
...
C['FOXHOLE_TEMPLATES'] = {
    ...
    'pl': ['deployable_foxhole_sp'],
    'ru': ['deployable_foxhole_sp'],
    'ru90': ['deployable_foxhole_sp'],
    'idf': ['deployable_foxhole_sp'],
    'chinsurgent': ['deployable_foxhole_sp'],
    'chinsurgent90': ['deployable_foxhole_sp'],
    'chechen90': ['deployable_foxhole_sp'],
    'fsa': ['deployable_foxhole_sp'],
    'vnusa': ['deployable_foxhole_sp'],
    'vnusmc': ['deployable_foxhole_sp'],
    'vnnva': ['deployable_foxhole_sp'],
    'gb82': ['deployable_foxhole_sp'],
    'arg82': ['deployable_foxhole_sp'],
    'fr': ['deployable_foxhole_sp'],
    'nl': ['deployable_foxhole_sp'],
    'ww2ger': ['deployable_foxhole_sp'],
    'ww2ger41': ['deployable_foxhole_sp'],
    'ww2usa': ['deployable_foxhole_sp'],
    'ww2rus': ['deployable_foxhole_sp'],
    'ww2rusearly': ['deployable_foxhole_sp'],
}
#
#
...
C['RAZORWIRES_TEMPLATES'] = {
    'us': ['deployable_razorwire_sp'],
    'usa': ['deployable_razorwire_sp'],
    'cf': ['deployable_razorwire_sp'],
    'gb': ['deployable_razorwire_sp'],
    'ger': ['deployable_razorwire_sp'],
    'ch': ['deployable_razorwire_sp'],
    'mec': ['deployable_razorwire_sp'],
    'pl': ['deployable_razorwire_sp'],
    'ru': ['deployable_razorwire_sp'],
    'ru90': ['deployable_razorwire_sp'],
    'idf': ['deployable_razorwire_sp'],
    'chinsurgent': ['deployable_razorwire_sp'],
    'chinsurgent90': ['deployable_razorwire_sp'],
    'chechen90': ['deployable_razorwire_sp'],
    'vnusa': ['deployable_razorwire_sp'],
    'vnusmc': ['deployable_razorwire_sp'],
    'vnnva': ['deployable_razorwire_sp'],
    'gb82': ['deployable_razorwire_sp'],
    'arg82': ['deployable_razorwire_sp'],
    'fr': ['deployable_razorwire_sp'],
    'nl': ['deployable_razorwire_sp'],
    'ww2ger': ['deployable_razorwire_sp'],
    'ww2ger41': ['deployable_razorwire_sp'],
    'ww2usa': ['deployable_razorwire_sp'],
    'ww2rus': ['deployable_razorwire_sp'],
    'ww2rusearly': ['deployable_razorwire_sp'],
}
#
#
# The razorwire templates for each team
...
C['ROADBLOCK_SHORT_TEMPLATES'] = {
    'fsa': ['deployable_roadblock_s01_sp', 'deployable_roadblock_s02_sp'],
    'hamas': ['deployable_roadblock_s01_sp', 'deployable_roadblock_s02_sp'],
    'meinsurgent': ['deployable_roadblock_s01_sp', 'deployable_roadblock_s02_sp'],
    'arf': ['deployable_roadblock_s01_sp', 'deployable_roadblock_s02_sp'],
}
#
#
# The roadblock_short templates for each team
...
C['ROADBLOCK_LONG_TEMPLATES'] = {
    'fsa': ['deployable_roadblock_l01_sp', 'deployable_roadblock_l02_sp', 'deployable_roadblock_l03_sp'],
    'hamas': ['deployable_roadblock_l01_sp', 'deployable_roadblock_l02_sp', 'deployable_roadblock_l03_sp'],
    'meinsurgent': ['deployable_roadblock_l01_sp', 'deployable_roadblock_l02_sp', 'deployable_roadblock_l03_sp'],
    'arf': ['deployable_roadblock_l01_sp', 'deployable_roadblock_l02_sp', 'deployable_roadblock_l03_sp'],
}
#
#
# The roadblock_long templates for each team
...
C['SANDBAGS_TEMPLATES'] = {
    'us': ['deployable_sandbags_5m_sp'],
    'usa': ['deployable_sandbags_5m_sp'],
    'cf': ['deployable_sandbags_5m_sp'],
    'gb': ['deployable_sandbags_5m_sp'],
    'ger': ['deployable_sandbags_5m_sp'],
    'ch': ['deployable_sandbags_5m_sp'],
    'mec': ['deployable_sandbags_5m_sp'],
    'pl': ['deployable_sandbags_5m_sp'],
    'ru': ['deployable_sandbags_5m_sp'],
    'ru90': ['deployable_sandbags_5m_sp'],
    'idf': ['deployable_sandbags_5m_sp'],
    'fsa': ['deployable_sandbags_5m_sp'],
    'chinsurgent': ['deployable_sandbags_5m_sp'],
    'chinsurgent90': ['deployable_sandbags_5m_sp'],
    'chechen90': ['deployable_sandbags_5m_sp'],
    'vnusa': ['deployable_sandbags_5m_sp'],
    'vnusmc': ['deployable_sandbags_5m_sp'],
    'vnnva': ['deployable_sandbags_5m_sp'],
    'gb82': ['deployable_sandbags_5m_sp'],
    'arg82': ['deployable_sandbags_5m_sp'],
    'fr': ['deployable_sandbags_5m_sp'],
    'nl': ['deployable_sandbags_5m_sp'],
    'ww2ger': ['deployable_sandbags_5m_sp'],
    'ww2ger41': ['deployable_sandbags_5m_sp'],
    'ww2usa': ['deployable_sandbags_5m_sp'],
    'ww2rus': ['deployable_sandbags_5m_sp'],
    'ww2rusearly': ['deployable_sandbags_5m_sp'],
}
#
#
...
C['EXPLOSION_LAGCOMP_DISABLE'] = [
    ...
    # Air to air
    "aa11_archer", "aim9", "aim120_amraam", "ru_aa_r60m", "aim9b_sidewinder", "matra_r550_magic1", "matra_r530",
    "aim9l_sidewinder", "ru_aa_r27re",
    # SACLOS -
...
#
C["RANDOMIZE_KITS"] = 1
C["SPECIFIC_EXCLUDED_KITS"] = ()
#
#
C["BOT_DYNAMIC_RESPAWN"] = 0
C["SPAWN_TIME_MODIFIER"] = 1.0
#
#
